...
extension String {
    ...
    package struct Localizable: Hashable, Sendable {
        ...
        /// My snake case
        /// ```
        package static var my_snake_case: Localizable {
            Localizable(
                key: "my_snake_case",
                arguments: [],
                table: "Localizable"
        ...
        /// ```
        package static var mySnake_caseWithMultipleSeparators: Localizable {
            Localizable(
        ...
        package static func ==(lhs: Localizable, rhs: Localizable) -> Bool {
